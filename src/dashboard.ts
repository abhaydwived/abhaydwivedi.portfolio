...
class CloudDashboard {
    ...
    [key: string]: any; // To handle dynamic chart properties like this['cloudSkillsChart']
    ...
    initializeAnimations() {
        // Method called in constructor but defined as placeholder or for specific triggers
    }
    ...
    animateCounters() {
        document.querySelectorAll('.stat-number').forEach(counter => {
            const _target = parseInt((counter as HTMLElement).dataset.target || "0");
            const duration = 2;
            ...
            gsap.from(counter, {
                ...
                delay: 1.8,
                onUpdate: function () {
                    // console.log(this.targets()[0].innerHTML);
                }
            });
        });
    }
    ...
    createSkillChart(canvasId: string, config: any) {
